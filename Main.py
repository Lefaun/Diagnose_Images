...
data_dir = 'https://drive.google.com/drive/folders/1O6ZimdPrpby5opBy8WtavAr6X7Hp2xdU?usp=drive_link/train'
...
with col1:
    ...
    visualize_model_predictions(
        model_conv, img_path=image.load_img(uploaded_file, target_size=(224, 224))
    )
